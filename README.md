...
## Server details
   ...
   > * Private IP:172.26.12.74
   > * Public IP:35.158.243.50
   > * SSH port: 2200                                 
   > * URL:http://172.26.12.74/
...
* Connect to instance.
> * ssh -i ~/.ssh/DefaultKey.pem ubuntu@172.26.12.74
...
* Connect to grader
> ssh -i ~/.ssh/grader_key grader@172.26.12.74 -p 2200
